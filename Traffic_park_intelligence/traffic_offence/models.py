...
class FineCollect(models.Model):
    ...
    collect_time = models.TimeField(default=current_time, verbose_name="Collection Time")
...
class NoParking(models.Model):
    ...
    Tiger_id = models.CharField(max_length=100)
    collect_date = models.DateField(auto_now_add=True, verbose_name="Collection Date")
...
class RegisterTrafficOffence(models.Model):
    ...
    fine_total = models.DecimalField(max_digits=10, decimal_places=2, null=True,)
    compid = models.CharField(max_length=50, unique=True,  null=True,)
